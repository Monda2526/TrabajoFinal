...
public class AnalizadorSintactico1 {
    ...
    public void analizar() {
                ...
                case "Variables", "Número" -> {
                    if (i + 1 < tokens.size()) {
                        ...
                        if (!sigTipo.equals("Punto y coma") &&
                            ...
                            // Verificar si estamos dentro de una función tipo printf
                            ...
                            if (!esParteDeFuncion) {
                                errores.append("Error sintáctico en línea ").append(linea)
                                       .append(": posible falta de punto y coma ';'\n");
                            }
                        }
                    }
                }
        ...
        while (!pila.isEmpty()) {
            ...
            if (s.simbolo.equals("{")) {
                errores.append("Error sintáctico en línea ").append(s.linea)
                       .append(": falta la llave de cierre '}'\n");
            } else if (s.simbolo.equals("(")) {
                errores.append("Error sintáctico en línea ").append(s.linea)
                       .append(": falta el paréntesis de cierre ')'\n");
            }
        }
    }
